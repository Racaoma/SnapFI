...
def main(argv):
	...
	#Get Inputs
	if(len(argv) < 2):
		print("Error! DFIRE.py requires 2 arguments: <Output_File> and <IDs_File>")
		sys.exit(2)
	...
	#Display Progress
	print("Extracting DFIRE from \"" + "Step_" + argv[1] + ".txt\"")
	...
	for id_num in ids:
		...
		#Calculate dDFIRE
		os.system("echo -n " + id_num + "'\t' >> " + output_file + " | ./dDFIRE " + model_file + " | awk '{print $3}' >> " + output_file)
